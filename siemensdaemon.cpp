...
rlSiemensTCP   slave0("192.168.1.254",rlSiemensTCP::S7_300,0,3,100);
rlSharedMemory shm("C:\\automation\\shm\\siemens.shm",48);
rlMailbox      mbx("C:\\automation\\mbx\\siemens.mbx");
rlThread       thread;
